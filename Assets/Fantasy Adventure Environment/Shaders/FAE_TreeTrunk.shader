...
//		#pragma instancing_options assumeuniformscaling lodfade maxcount:50 procedural:setup
		...
		#pragma surface surf Standard vertex:vertexDataFunc addshadow 
		#pragma skip_variants: LOD_FADE_PERCENTAGE LOD_FADE_CROSSFADE FOG_LINEAR FOG_EXP FOG_EXP2 INSTANCING_ON DIRECTIONAL LIGHTPROBE_SH SHADOWS_SHADOWMASK LIGHTMAP_ON LIGHTMAP_SHADOW_MIXING SHADOWS_SCREEN VERTEXLIGHT_ON
		struct Input
		{
			float2 uv_texcoord;
		...
		void vertexDataFunc( inout appdata_full v, out Input o )
		{
			...
			float3 temp_output_41_0 = ( appendResult93 * _TrunkWindWeight * lerp(v.color.a,( v.texcoord1.xy.y * 0.01 ),_UseSpeedTreeWind) );
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float4 lerpResult85 = lerp( ( _GradientBrightness * tex2DNode45 ) , tex2DNode45 , lerp(( 1.0 - ( i.vertexColor.a * 10.0 ) ),i.uv2_texcoord2.y,_UseSpeedTreeWind));
			float4 Albedo115 = lerpResult85;
...
/*ASEBEGIN
Version=18707
134;57;1571;858;-795.4532;1842.052;1.084144;True;True
...
Node;AmplifyShaderEditor.RangedFloatNode;13;-423.8982,-2188.46;Float;False;Global;_WindSpeed;_WindSpeed;7;0;Create;True;0;0;False;0;False;0.3;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.Vector4Node;18;-98.73761,-1770.237;Float;False;Global;_WindDirection;_WindDirection;9;0;Create;True;0;0;False;0;False;0,0,0,0;0,0,0,0;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;27;587.163,-1464.039;Float;False;Global;_TrunkWindSwinging;_TrunkWindSwinging;10;0;Create;True;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;16;-122.4307,-1559.33;Float;False;Global;_TrunkWindSpeed;_TrunkWindSpeed;10;0;Create;True;0;0;False;0;False;10;0;0;0;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=1385E9A0A3F3E84FD03CF75BC273AD19AA59CCE8
