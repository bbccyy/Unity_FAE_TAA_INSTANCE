Shader "sg3/Fx/ThreeInOne_Blend_CB"
{
	Properties
	{
		...
		Pass
		{
			...
			struct v2f
			{
   			...
   			half4 frag (v2f i ) : SV_Target
   			{
				...
				return half4 (finalCol, dissolve * col.a * _TintColor.a * i.vertexColor.a * maskAll.r);
   			}
   			ENDHLSL
   		}
   	}
		...
		Pass
		{
			...
			struct v2f
			{
   			...
   			fixed4 frag (v2f i ) : SV_Target
   			{
				...
				return fixed4 (finalCol, dissolve * col.a * _TintColor.a * i.vertexColor.a * maskAll.r);
   			}
   			ENDCG
   		}
   	}
