	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float2 appendResult96 = (float2(WorldPosition.y , WorldPosition.z));
				...
				float3 temp_output_7_0 = abs( mul( GetWorldToObjectMatrix(), float4( WorldNormal , 0.0 ) ).xyz );
				float dotResult9 = dot( temp_output_7_0 , float3(1,1,1) );
				float3 BlendComponents11 = ( temp_output_7_0 / dotResult9 );
				float2 appendResult94 = (float2(WorldPosition.x , WorldPosition.z));
				float2 appendResult95 = (float2(WorldPosition.x , WorldPosition.y));
				...
				float3 unpack2 = UnpackNormalScale( tex2D( _Objectnormals, uv_Objectnormals2 ), 1.0 );
				...
				float3 unpack48 = UnpackNormalScale( tex2D( _Detailnormal, uv_Detailnormal ), 1.0 );
				unpack48.z = lerp( 1, unpack48.z, saturate(1.0) );
				float3 lerpResult57 = lerp( tex2DNode2 , BlendNormal( tex2DNode2 , unpack48 ) , _Detailstrength);
...
/*ASEBEGIN
Version=18707
378;132;1795;795;3378.516;566.1127;1;True;True
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;98;1969.099,-112.4;Float;False;True;-1;2;UnityEditor.ShaderGraph.PBRMasterGUI;0;2;FAE/Cliff;94348b07e5e8bab40bd6c8a1e3df54cd;True;Forward;0;1;Forward;17;False;False;False;False;False;False;False;False;True;0;False;-1;True;0;False;-1;False;False;False;False;False;False;False;False;True;3;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;0;0;True;1;1;False;-1;0;False;-1;1;1;False;-1;0;False;-1;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;-1;False;False;False;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;True;1;False;-1;True;3;False;-1;True;True;0;False;-1;0;False;-1;True;1;LightMode=UniversalForward;False;0;Hidden/InternalErrorShader;0;0;Standard;36;Workflow;1;Surface;0;  Refraction Model;0;  Blend;0;Two Sided;1;Fragment Normal Space,InvertActionOnDeselection;0;Transmission;0;  Transmission Shadow;0.5,False,-1;Translucency;0;  Translucency Strength;1,False,-1;  Normal Distortion;0.5,False,-1;  Scattering;2,False,-1;  Direct;0.9,False,-1;  Ambient;0.1,False,-1;  Shadow;0.5,False,-1;Cast Shadows;1;  Use Shadow Threshold;0;Receive Shadows;1;GPU Instancing;1;LOD CrossFade;1;Built-in Fog;1;_FinalColorxAlpha;0;Meta Pass;1;Override Baked GI;0;Extra Pre Pass;0;DOTS Instancing;0;Tessellation;0;  Phong;0;  Strength;0.5,False,-1;  Type;0;  Tess;16,False,-1;  Min;10,False,-1;  Max;25,False,-1;  Edge Length;16,False,-1;  Max Displacement;25,False,-1;Vertex Position,InvertActionOnDeselection;1;0;6;False;True;True;True;True;True;False;;False;0
...
ASEEND*/
//CHKSM=D112C48158A180670AA34DF0A0C8AA294414AA60