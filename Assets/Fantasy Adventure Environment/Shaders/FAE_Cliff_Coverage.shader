...
Shader "FAE/Cliff coverage"
{
	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				half2 appendResult96 = (half2(WorldPosition.y , WorldPosition.z));
				float cos68 = cos( 1.55 );
				float sin68 = sin( 1.55 );
				half2 rotator68 = mul( appendResult96 - float2( 0,0 ) , float2x2( cos68 , -sin68 , sin68 , cos68 )) + float2( 0,0 );
				half3 temp_output_7_0 = abs( mul( GetWorldToObjectMatrix(), half4( WorldNormal , 0.0 ) ).xyz );
				half dotResult9 = dot( temp_output_7_0 , float3(1,1,1) );
				float3 BlendComponents11 = ( temp_output_7_0 / dotResult9 );
				half2 appendResult94 = (half2(WorldPosition.x , WorldPosition.z));
				half2 appendResult95 = (half2(WorldPosition.x , WorldPosition.y));
				float2 uv_Objectalbedo1 = IN.ase_texcoord7.xy;
				half4 tex2DNode1 = tex2D( _Objectalbedo, uv_Objectalbedo1 );
				half4 blendOpSrc42 = ( _GlobalColor * ( ( ( tex2D( _Globalalbedo, ( _Globaltiling * rotator68 ) ) * BlendComponents11.x ) + ( tex2D( _Globalalbedo, ( _Globaltiling * appendResult94 ) ) * BlendComponents11.y ) ) + ( tex2D( _Globalalbedo, ( _Globaltiling * appendResult95 ) ) * BlendComponents11.z ) ) );
				half4 blendOpDest42 = ( _ObjectColor * tex2DNode1 );
				half2 texCoord111 = IN.ase_texcoord7.xy * float2( 1,1 ) + float2( 0,0 );
				half2 temp_output_113_0 = ( texCoord111 * _CoverageTiling );
				float2 uv_Objectnormals2 = IN.ase_texcoord7.xy;
				half3 unpack2 = UnpackNormalScale( tex2D( _Objectnormals, uv_Objectnormals2 ), 1.0 );
				unpack2.z = lerp( 1, unpack2.z, saturate(1.0) );
				half3 tex2DNode2 = unpack2;
				float2 uv_Detailnormal48 = IN.ase_texcoord7.xy;
				half3 unpack48 = UnpackNormalScale( tex2D( _Detailnormal, uv_Detailnormal48 ), 1.0 );
				unpack48.z = lerp( 1, unpack48.z, saturate(1.0) );
				half3 lerpResult57 = lerp( tex2DNode2 , BlendNormal( tex2DNode2 , unpack48 ) , _Detailstrength);
				half2 appendResult117 = (half2(_TerrainUV.z , _TerrainUV.w));
				float2 TerrainUV125 = ( ( ( 1.0 - appendResult117 ) / _TerrainUV.x ) + ( ( _TerrainUV.x / ( _TerrainUV.x * _TerrainUV.x ) ) * (WorldPosition).xz ) );
				half temp_output_127_0 = ( tex2D( _CoverageMap, TerrainUV125 ).r * _CoverageAmount );
				half3 lerpResult105 = lerp( lerpResult57 , UnpackNormalScale( tex2D( _CoverageNormals, temp_output_113_0 ), 1.0f ) , saturate( ( WorldNormal.y * temp_output_127_0 ) ));
				...
				float3 tanNormal106 = lerpResult105;
				half3 worldNormal106 = float3(dot(tanToWorld0,tanNormal106), dot(tanToWorld1,tanNormal106), dot(tanToWorld2,tanNormal106));
				half temp_output_110_0 = saturate( ( worldNormal106.y * temp_output_127_0 ) );
				half4 lerpResult97 = lerp( ( saturate( (( blendOpDest42 > 0.5 ) ? ( 1.0 - 2.0 * ( 1.0 - blendOpDest42 ) * ( 1.0 - blendOpSrc42 ) ) : ( 2.0 * blendOpDest42 * blendOpSrc42 ) ) )) , tex2D( _CoverageAlbedo, temp_output_113_0 ) , temp_output_110_0);
				
				half lerpResult74 = lerp( 0.0 , ( _Roughness * tex2DNode1.a ) , IN.ase_color.g);
				
				float3 Albedo = lerpResult97.rgb;
				float3 Normal = lerpResult105;
				float3 Emission = 0;
				float3 Specular = 0.5;
				float Metallic = 0;
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				half3 temp_output_7_0 = abs( mul( GetWorldToObjectMatrix(), half4( ase_worldNormal , 0.0 ) ).xyz );
				half dotResult9 = dot( temp_output_7_0 , float3(1,1,1) );
				float3 BlendComponents11 = ( temp_output_7_0 / dotResult9 );
				half2 appendResult94 = (half2(WorldPosition.x , WorldPosition.z));
				half2 appendResult95 = (half2(WorldPosition.x , WorldPosition.y));
				float2 uv_Objectalbedo1 = IN.ase_texcoord3.xy;
				half4 tex2DNode1 = tex2D( _Objectalbedo, uv_Objectalbedo1 );
				half4 blendOpSrc42 = ( _GlobalColor * ( ( ( tex2D( _Globalalbedo, ( _Globaltiling * rotator68 ) ) * BlendComponents11.x ) + ( tex2D( _Globalalbedo, ( _Globaltiling * appendResult94 ) ) * BlendComponents11.y ) ) + ( tex2D( _Globalalbedo, ( _Globaltiling * appendResult95 ) ) * BlendComponents11.z ) ) );
				half4 blendOpDest42 = ( _ObjectColor * tex2DNode1 );
				half2 texCoord111 = IN.ase_texcoord3.xy * float2( 1,1 ) + float2( 0,0 );
				half2 temp_output_113_0 = ( texCoord111 * _CoverageTiling );
				float2 uv_Objectnormals2 = IN.ase_texcoord3.xy;
				half3 unpack2 = UnpackNormalScale( tex2D( _Objectnormals, uv_Objectnormals2 ), 1.0 );
				unpack2.z = lerp( 1, unpack2.z, saturate(1.0) );
				half3 tex2DNode2 = unpack2;
				float2 uv_Detailnormal48 = IN.ase_texcoord3.xy;
				half3 unpack48 = UnpackNormalScale( tex2D( _Detailnormal, uv_Detailnormal48 ), 1.0 );
				unpack48.z = lerp( 1, unpack48.z, saturate(1.0) );
				half3 lerpResult57 = lerp( tex2DNode2 , BlendNormal( tex2DNode2 , unpack48 ) , _Detailstrength);
				half2 appendResult117 = (half2(_TerrainUV.z , _TerrainUV.w));
				float2 TerrainUV125 = ( ( ( 1.0 - appendResult117 ) / _TerrainUV.x ) + ( ( _TerrainUV.x / ( _TerrainUV.x * _TerrainUV.x ) ) * (WorldPosition).xz ) );
				half temp_output_127_0 = ( tex2D( _CoverageMap, TerrainUV125 ).r * _CoverageAmount );
				half3 lerpResult105 = lerp( lerpResult57 , UnpackNormalScale( tex2D( _CoverageNormals, temp_output_113_0 ), 1.0f ) , saturate( ( ase_worldNormal.y * temp_output_127_0 ) ));
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float3 lerpResult57 = lerp( tex2DNode2 , BlendNormals( tex2DNode2 , UnpackScaleNormal( tex2D( _Detailnormal, uv_Detailnormal48 *_Detailtiling) ,1.0 ) ) , _Detailstrength);
...
//			float4 blendOpSrc42 = ( _GlobalColor * ( ( ( tex2D( _Globalalbedo, ( _Globaltiling * rotator68 ) )  * BlendComponents11.x ))) );
...
//			float temp_output_110_0 = saturate( ( WorldNormalVector( i , lerpResult105 ).y * temp_output_127_0 ) );
			float3 f = WorldNormalVector( i , lerpResult105 );
			//f.y *= 0.5;
			f.y = pow(f.y, 1.7);
			f = normalize(f);
			float temp_output_110_0 = saturate( ( f.y * temp_output_127_0 ) );
		...
		Pass
		{
			...
			#pragma shader_feature UNITY_PASS_SHADOWCASTER
	...
	/*ase_lod*/
	//CustomEditor "UnityEditor.ShaderGraph"
	Fallback "Babeltime/Diffuse"
	
}
/*ASEBEGIN
Version=18707
134;57;1571;858;538.1475;-565.5649;1;True;True
...
Node;AmplifyShaderEditor.Vector3Node;8;-3815.781,-170.9255;Float;False;Constant;_Vector1;Vector 1;-1;0;Create;True;0;0;False;0;False;1,1,1;0,0,0;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.AbsOpNode;7;-3782.662,-351.3753;Inherit;False;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.Vector4Node;115;-2362.519,1476.344;Float;False;Global;_TerrainUV;_TerrainUV;2;0;Create;True;0;0;False;0;False;0,0,0,0;0,0,0,0;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;69;-2453.705,-680.8949;Float;False;Constant;_Float0;Float 0;9;0;Create;True;0;0;False;0;False;1.55;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;16;-2245.521,-1016.58;Float;False;Property;_Globaltiling;Global tiling;5;0;Create;True;0;0;False;0;False;1.56;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;100;-592.8126,1661.028;Float;False;Property;_CoverageAmount;CoverageAmount;11;0;Create;True;0;0;False;0;False;0.13;0;0;2;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;126;-603.3663,1438.713;Inherit;True;Property;_CoverageMap;CoverageMap;13;0;Create;True;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;1;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;93;-1185.708,886.2039;Float;False;Constant;_Float2;Float 2;10;0;Create;True;0;0;False;0;False;1;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;112;-469.2005,453.3063;Float;False;Property;_CoverageTiling;CoverageTiling;12;0;Create;True;0;0;False;0;False;0;0;0;5;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;2;-967.5005,739.1008;Inherit;True;Property;_Objectnormals;Object normals;2;1;[NoScaleOffset];Create;True;0;0;False;0;False;-1;None;None;True;0;True;bump;Auto;True;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;0;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;40;-1732.56,-756.6757;Inherit;True;Property;_Globalalbedo;Global albedo;4;1;[NoScaleOffset];Create;True;0;0;False;0;False;-1;None;None;True;0;False;gray;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;0,0;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;0;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;56;-501.5017,984.6024;Float;False;Property;_Detailstrength;Detail strength;7;0;Create;True;0;0;False;0;False;1;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;41;-1737.643,-501.2136;Inherit;True;Property;_TextureSample5;Texture Sample 5;4;0;Create;True;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Instance;40;Auto;Texture2D;8;0;SAMPLER2D;0,0;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;0;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;104;140.6917,489.8538;Inherit;True;Property;_CoverageNormals;Coverage Normals;9;1;[NoScaleOffset];Create;True;0;0;False;0;False;-1;None;None;True;0;True;bump;Auto;True;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;0,0;False;1;FLOAT2;0,0;False;2;FLOAT;1;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;1;-1020.2,-111.2999;Inherit;True;Property;_Objectalbedo;Object albedo;1;1;[NoScaleOffset];Create;True;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;0;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;58;-682.3034,-232.3961;Float;False;Property;_ObjectColor;Object Color;0;0;Create;True;0;0;False;0;False;1,1,1,0;0,0,0,0;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;61;-783.5037,-641.4963;Float;False;Property;_GlobalColor;Global Color;3;0;Create;True;0;0;False;0;False;1,1,1,0;0,0,0,0;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;109;628.4915,332.7543;Inherit;True;Property;_CoverageAlbedo;Coverage Albedo;8;1;[NoScaleOffset];Create;True;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;0,0;False;1;FLOAT2;0,0;False;2;FLOAT;1;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;63;2.497352,58.20351;Float;False;Property;_Roughness;Roughness;10;0;Create;True;0;0;False;0;False;0.5;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;75;753.7921,87.00389;Float;False;Constant;_Float1;Float 1;9;0;Create;True;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;129;1969.099,-112.4;Float;False;False;-1;2;UnityEditor.ShaderGraph.PBRMasterGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;ExtraPrePass;0;0;ExtraPrePass;5;False;False;False;False;False;False;False;False;True;0;False;-1;True;0;False;-1;False;False;False;False;False;False;False;False;True;3;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;0;0;True;1;1;False;-1;0;False;-1;0;1;False;-1;0;False;-1;False;False;False;False;False;False;False;False;True;0;False;-1;True;True;True;True;True;0;False;-1;False;False;False;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;True;1;False;-1;True;3;False;-1;True;True;0;False;-1;0;False;-1;True;0;False;0;Hidden/InternalErrorShader;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;133;1969.099,-112.4;Float;False;False;-1;2;UnityEditor.ShaderGraph.PBRMasterGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;Meta;0;4;Meta;0;False;False;False;False;False;False;False;False;True;0;False;-1;True;0;False;-1;False;False;False;False;False;False;False;False;True;3;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;0;0;False;False;False;False;False;False;False;False;False;True;2;False;-1;False;False;False;False;False;False;False;False;True;1;LightMode=Meta;False;0;Hidden/InternalErrorShader;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;130;1969.099,-112.4;Half;False;True;-1;2;UnityEditor.ShaderGraph.PBRMasterGUI;0;2;FAE/Cliff coverage;94348b07e5e8bab40bd6c8a1e3df54cd;True;Forward;0;1;Forward;17;False;False;False;False;False;False;False;False;True;0;False;-1;True;0;False;-1;False;False;False;False;False;False;False;False;True;3;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;0;0;True;1;1;False;-1;0;False;-1;1;1;False;-1;0;False;-1;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;-1;False;False;False;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;True;1;False;-1;True;3;False;-1;True;True;0;False;-1;0;False;-1;True;1;LightMode=UniversalForward;False;0;Hidden/InternalErrorShader;0;0;Standard;36;Workflow;1;Surface;0;  Refraction Model;0;  Blend;0;Two Sided;1;Fragment Normal Space,InvertActionOnDeselection;0;Transmission;0;  Transmission Shadow;0.5,False,-1;Translucency;0;  Translucency Strength;1,False,-1;  Normal Distortion;0.5,False,-1;  Scattering;2,False,-1;  Direct;0.9,False,-1;  Ambient;0.1,False,-1;  Shadow;0.5,False,-1;Cast Shadows;1;  Use Shadow Threshold;0;Receive Shadows;1;GPU Instancing;1;LOD CrossFade;1;Built-in Fog;1;_FinalColorxAlpha;0;Meta Pass;1;Override Baked GI;0;Extra Pre Pass;0;DOTS Instancing;0;Tessellation;0;  Phong;0;  Strength;0.5,False,-1;  Type;0;  Tess;16,False,-1;  Min;10,False,-1;  Max;25,False,-1;  Edge Length;16,False,-1;  Max Displacement;25,False,-1;Vertex Position,InvertActionOnDeselection;1;0;6;False;True;True;True;True;True;False;;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;132;1969.099,-112.4;Float;False;False;-1;2;UnityEditor.ShaderGraph.PBRMasterGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;DepthOnly;0;3;DepthOnly;0;False;False;False;False;False;False;False;False;True;0;False;-1;True;0;False;-1;False;False;False;False;False;False;False;False;True;3;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;0;0;False;False;False;False;False;False;False;False;True;0;False;-1;False;True;False;False;False;False;0;False;-1;False;False;False;False;True;1;False;-1;False;False;True;1;LightMode=DepthOnly;False;0;Hidden/InternalErrorShader;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;131;1969.099,-112.4;Float;False;False;-1;2;UnityEditor.ShaderGraph.PBRMasterGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;ShadowCaster;0;2;ShadowCaster;0;False;False;False;False;False;False;False;False;True;0;False;-1;True;0;False;-1;False;False;False;False;False;False;False;False;True;3;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;0;0;False;False;False;False;False;False;False;False;True;0;False;-1;False;False;False;False;False;False;True;1;False;-1;True;3;False;-1;False;True;1;LightMode=ShadowCaster;False;0;Hidden/InternalErrorShader;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;134;1969.099,-112.4;Float;False;False;-1;2;UnityEditor.ShaderGraph.PBRMasterGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;Universal2D;0;5;Universal2D;0;False;False;False;False;False;False;False;False;True;0;False;-1;True;0;False;-1;False;False;False;False;False;False;False;False;True;3;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;0;0;True;1;1;False;-1;0;False;-1;1;1;False;-1;0;False;-1;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;-1;False;False;False;False;True;1;False;-1;True;3;False;-1;True;True;0;False;-1;0;False;-1;True;1;LightMode=Universal2D;False;0;Hidden/InternalErrorShader;0;0;Standard;0;False;0
...
WireConnection;130;1;105;0
WireConnection;130;4;74;0
ASEEND*/
//CHKSM=9145593904C0F59E6F658D7EF6EA82818992469B